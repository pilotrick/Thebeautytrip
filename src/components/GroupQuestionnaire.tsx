...
// Utility function to calculate group discount percentage
export function getGroupDiscount(groupSize: number): number {
  if (groupSize >= 15) return 20;
...
export function GroupQuestionnaire({ onSubmit, onBack }: GroupQuestionnaireProps) {
  ...
  const [tripDuration, setTripDuration] = useState(5); // Default 5 nights
  ...
  const getStepTitle = (step: number): string => {
    switch(step) {
      case 1: return "Group Size";
      case 2: return "Celebration Type";
      case 3: return "Budget & Duration";
      case 4: return "Procedure Focus";
      case 5: return "Coordinator Details";
      default: return "Group Setup";
    }
  };

  const getStepMainTitle = (step: number): string => {
    switch(step) {
      case 1: return "Your Luxury Group Transformation Begins";
      case 2: return "Celebrate Your Milestone in Style";
      case 3: return "Design Your Premium Dominican Experience";
      case 4: return "Curate Your Group's Aesthetic Journey";
      case 5: return "Secure Your Celebration";
      default: return "Your Group Celebration Awaits";
    }
  };

  const getStepSubtitle = (step: number): string => {
    switch(step) {
      case 1: return "Luxury wellness group packages • Dominican Republic transformation retreats";
      case 2: return "Bachelorette spa retreats • Group beauty transformation experiences";
      case 3: return "All-inclusive medspa packages • Luxury villa accommodations Dominican Republic";
      case 4: return "Non-invasive cosmetic procedures • Group dental wellness packages";
      case 5: return "Secure your custom group wellness experience";
      default: return "Luxury group wellness retreat";
    }
  };

  return (
    <div className="min-h-screen bg-white">
      {/* Thin Header with Progress */}
      <ProgressBar 
